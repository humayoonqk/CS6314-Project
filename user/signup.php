      ...
      var phoneCheck = true;
        ...
        $('#email').blur(function(){
            ...
            if (check != null && check != "") {
                ...
                $('#uEmail').html("Please Enter the email address");
                $('#uEmail').css("color", "red");
                emailCheck = false;
            }
        ...
        $("#submit").click(function() {
          if (nameCheck == true && emailCheck == true && passwordCheck == true && phoneCheck == true) {
            ...
            $('#messagebox').html("Please complete all feilds correctly.");
