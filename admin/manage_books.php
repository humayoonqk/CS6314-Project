<?php
 ...
 <div class="container">
   ...
   <img class="card-img-top" src="images/add_books.png" alt="Card image cap" height="200" style="width:80%">
   <div class="card-body">
 ...
 <div class="card" style="width: 18rem;">
 <img class="card-img-top" src="images/view_books.jpeg" alt="Card image cap" height="200" style="width:80%">
 <div class="card-body">
 ...
 <div class="card" style="width: 18rem;">
 <img class="card-img-top" src="images/delete_book.png" alt="Card image cap" height="200" style="width:80%">
 <div class="card-body">
